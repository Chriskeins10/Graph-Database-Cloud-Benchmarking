...
NODES_FILE = Path("../datasets/nodes.csv")
RELS_FILE = Path("../datasets/relationships.csv")

BATCH_SIZE = 100          # Very small for free tier
            ...
            if len(batch) >= BATCH_SIZE:
                ...
                for attempt in range(3):  # retry up to 3 times
                    try:
                        ...
                        print(f"\n  Connection lost. Retrying batch... (attempt {attempt+1})")
                        time.sleep(2)
